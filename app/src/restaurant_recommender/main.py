...
async def recommend_restaurant(
    ...
    vegetarian: Optional[bool] = Query(None, description="Filter for vegetarian restaurants")
):
    ...
    restaurant_dict['open_hour'] = restaurant_dict['open_hour'].strftime('%H:%M:%S')
    restaurant_dict['close_hour'] = restaurant_dict['close_hour'].strftime('%H:%M:%S')
    return JSONResponse(
